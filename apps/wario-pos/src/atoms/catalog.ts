...
export type CatalogDialog = 'NONE' | 'CategoryInterstitial' | 'CategoryAdd' | 'CategoryEdit' | 'CategoryDelete' | 'ProductAdd' | 'ProductImport' | 'HierarchicalProductImport' | 'ProductEdit' | 'ProductDisableUntilEod' | 'ProductDisable' | 'ProductEnable' | 'ProductCopy' | 'ProductDelete' | 'ProductInstanceAdd' | 'ProductInstanceEdit' | 'ProductInstanceDelete' | 'ModifierTypeAdd' | 'ModifierTypeEdit' | 'ModifierTypeCopy' | 'ModifierTypeDelete' | 'ModifierOptionAdd' | 'ModifierOptionEdit' | 'ModifierOptionDelete' | 'ModifierOptionEnable' | 'ModifierOptionDisable' | 'ModifierOptionDisableUntilEod';
...
export const setDetailPanelSizeForRowIdAtom = atom(
  null,
  (get, set, { id, size }: { id: GridRowId; size: number }) => {
