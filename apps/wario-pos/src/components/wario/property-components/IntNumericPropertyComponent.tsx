import { formatDecimal, parseInteger } from "@wcp/wario-shared";
import { CheckedNumericInput, type CheckedNumericInputProps, type ValSetVal } from "@wcp/wario-ux-shared";
