...
export const StoreCreditIssueComponent = () => {
  ...
  return (
    <Card>
      <CardHeader
        title="Issue a store credit for a customer"
      ...
      <Grid sx={{ p: 1 }} container spacing={1.5} justifyContent="center">
        ...
        >
          <StringPropertyComponent disabled={isProcessing} label="Last Name" value={lastName} setValue={setLastName} />
        </Grid>
        <Grid
          size={{
            xs: 12,
        ...
        >
          <StringPropertyComponent disabled={isProcessing} label="Added by" value={addedBy} setValue={setAddedBy} />
        </Grid>
        <Grid
          size={{
            xs: 10,
        ...
        >
          <DatePicker
            ...
            onChange={(date: Date | number | null | undefined) => {
              setExpiration(date ? WDateUtils.formatISODate(date) : null);
            }}
        ...
        >
          <StringPropertyComponent disabled={isProcessing} label="Reason" value={reason} setValue={setReason} />
        </Grid>
        <Grid
          size={{
            xs: 3,
        ...
        >
          <ToggleBooleanPropertyComponent
            ...
            label="Is Discount?"
            setValue={(x) => {
              setCreditType(x ? StoreCreditType.DISCOUNT : StoreCreditType.MONEY);
            }}
