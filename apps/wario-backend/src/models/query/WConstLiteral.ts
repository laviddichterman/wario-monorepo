...
export const WConstStringLiteralExpressionSchema =
  WConstLiteralSchema.discriminator(
...
export const WConstNumberLiteralExpressionSchema =
  WConstLiteralSchema.discriminator(
...
export const WConstBooleanLiteralExpressionSchema =
  WConstLiteralSchema.discriminator(
...
export const WConstModifierPlacementLiteralExpressionSchema =
  WConstLiteralSchema.discriminator(
...
export const WConstModifierQualifierLiteralExpressionSchema =
  WConstLiteralSchema.discriminator(
