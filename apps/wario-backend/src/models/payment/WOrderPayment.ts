...
export const WCashPaymentSchema = WOrderPaymentSchema.discriminator(
  PaymentMethod.Cash,
...
export const WStoreCreditPaymentSchema = WOrderPaymentSchema.discriminator(
...
export const WCreditPaymentSchema = WOrderPaymentSchema.discriminator(
