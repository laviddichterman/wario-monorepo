...
export const AbstractExpressionConstLiteralSchema = WAbstractExpressionSchema.discriminator(
  ProductInstanceFunctionType.ConstLiteral,
...
export const AbstractExpressionHasAnyOfModifierExpressionSchema = WAbstractExpressionSchema.discriminator(
  ProductInstanceFunctionType.HasAnyOfModifierType,
...
export const AbstractExpressionIfElseExpressionSchema = WAbstractExpressionSchema.discriminator(
  ProductInstanceFunctionType.IfElse,
...
export const AbstractExpressionLogicalExpressionSchema = WAbstractExpressionSchema.discriminator(
  ProductInstanceFunctionType.Logical,
...
export const AbstractExpressionModifierPlacementExpressionSchema = WAbstractExpressionSchema.discriminator(
  ProductInstanceFunctionType.ModifierPlacement,
...
export const AbstractExpressionProductMetadataSchema = WAbstractExpressionSchema.discriminator(
  ProductInstanceFunctionType.ProductMetadata,
