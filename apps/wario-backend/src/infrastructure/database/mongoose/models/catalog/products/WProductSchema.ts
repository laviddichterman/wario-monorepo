...
import { PrepTimingSchema } from 'src/infrastructure/database/mongoose/models/PrepTimingSchema';
import { RecurringIntervalSchema } from 'src/infrastructure/database/mongoose/models/RecurringIntervalSchema';
import { KeyValueEntrySchema } from 'src/infrastructure/database/mongoose/models/settings/KeyValueSchema';
...
export const WProductModel = mongoose.model<IProduct>(
